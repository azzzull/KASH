...
flow = reconcile([transaction({ id: "lend-from-savings", type: "adjustment", amount: "-349", wallet_id: destinationWallet, related_entity_type: "receivable_creation" })]);
assert.deepEqual({ cashAdvance: flow.receivableOutflow, savingsAdvance: flow.receivableOutflowFromNonLiquidWallets, liquidity: flow.resultingLiquidityChange, residual: flow.unreconciledAmount }, { cashAdvance: 0, savingsAdvance: 349, liquidity: 0, residual: 0 });
